  ...
  return (
    <div
      className={`border-[2px] ${
        id === 3 ? "border-secondary" : "border-[#E6E7E8]"
      } xl:min-w-[300px] lg:min-w-[300px] md:min-w-[300px] sm:w-full xs:w-full xl:max-w-[300px] lg:max-w-[300px] max-h-[600px] pb-[150px] rounded-[20px] py-[24px] px-[16px]`}
    >
      <div className="flex flex-col gap-[32px]">
        <div className="flex flex-col gap-4">
          <h3 className="text-mainblack dark:text-dark-text text-[24px] font-[700]">
            {name}
          </h3>
          <p className="text-mainblack dark:text-dark-text text-[20px]">
            {t("aed")} {price} {t("mon")}
          </p>
        </div>
        <Button
        ...
        <p className="text-mainblack dark:text-dark-text text-[16px]">
          {description}
        </p>
        <hr className="border-t border-white dark:border-black" />
      </div>
      <div className="py-[16px]">
        <h4 className="text-[16px] font-[600] text-black dark:text-dark-text">
          {t("features")}
        </h4>
        <ul>
          {features?.map((el: FeatureT) => {
            return (
              <li
                key={el?.id}
                className="text-[#36393B] dark:text-dark-text flex justify-between items-center"
              >
                <p>{el?.name}</p>
                <div className="tooltip   tooltip-left rtl:tooltip-right ">
                  <div
                    className="tooltip-content bg-black dark:bg-white max-w-[250px]"
                    style={{ zIndex: 99999 }}
                  >
