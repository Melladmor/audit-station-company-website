        ...
        renderItem={(link) => {
          return (
            <RewardCard
              key={link?.id}
              {...link}
              className="rounded-[20px] border border-[#ACACAC]  xl:max-w-[356px] lg:max-w-[356px] md:max-w-auto sm:max-w-full xs:max-w-full xl:min-w-[356px] lg:min-w-[356px] md:min-w-[356px] sm:min-w-full xs:min-w-full"
