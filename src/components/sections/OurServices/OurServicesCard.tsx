...
const OurServicesCard = ({ data }: Props) => {
  ...
  return (
    <div
      className={`xl:h-[280px] lg:h-[548px] md:h-[430px] sm:h-[480px] xs:h-[380px] px-[24px] xl:py-[24px] lg:py-[24px] md:py-[24px] sm:py-[20px] xs:py-[14px] rounded-[16px] shadow-light `}
