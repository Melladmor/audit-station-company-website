...
const AboutUsSectionVideo = ({ url }: Props) => {
  ...
  return (
    <div className="xl:w-[526px] xl:h-[492px] lg:w-[500px] lg:h-[450px] md:w-[300px] md:h-[250px] sm:w-full sm:h-[260px] xs:w-full xs:h-[260px] xl:p-[24px] lg:p-[20px] md:p-[18px] sm:p-[14px] xs:p-[14px]  relative">
      ...
      <div
        className="xl:w-[478px] xl:h-[437px] lg:w-[430px] lg:h-[410px] md:w-[260px] md:h-[215px] sm:w-full sm:h-[230px] xs:w-full xs:h-[230px] bg-white  inset-0 bg-cover bg-center"
        style={{ backgroundImage: `url('/images/aboutusvideosection.jpg')` }}
      >
